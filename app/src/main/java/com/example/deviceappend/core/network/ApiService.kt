...
data class AiPhotoResponse(@SerializedName("sexo") val sexo: String, @SerializedName("edad_minima") val edad_minima: Int, @SerializedName("edad_maxima") val edad_maxima: Int)
